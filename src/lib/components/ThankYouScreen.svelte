...
<div class="min-h-screen bg-gradient-to-br from-green-400 via-blue-500 to-purple-600 flex items-center justify-center p-4 relative overflow-hidden">
  ...
  >
    <!-- Success Icon -->
    <div class="mb-8">
      <div class="w-24 h-24 {getLevelBadgeColor(completedLevels)} rounded-full mx-auto flex items-center justify-center shadow-lg transform rotate-3 hover:rotate-0 transition-transform duration-300">
        {#if isFullCompletion}
    ...
    <div class="mb-8">
      <h1 class="text-4xl font-bold text-gray-900 mb-4 bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">
        {performanceMessage}
      </h1>
    ...
    <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 mb-8">
      <h3 class="font-semibold text-gray-900 mb-6 flex items-center justify-center">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <!-- Total Questions -->
        <div class="text-center">
          <div class="w-16 h-16 bg-gradient-to-r from-blue-400 to-blue-600 rounded-2xl mx-auto flex items-center justify-center mb-3 shadow-lg">
        ...
        <!-- Correct Answers -->
        <div class="text-center">
          <div class="w-16 h-16 bg-gradient-to-r from-green-400 to-green-600 rounded-2xl mx-auto flex items-center justify-center mb-3 shadow-lg">
        ...
        <!-- Accuracy -->
        <div class="text-center">
          <div class="w-16 h-16 bg-gradient-to-r from-purple-400 to-purple-600 rounded-2xl mx-auto flex items-center justify-center mb-3 shadow-lg">
