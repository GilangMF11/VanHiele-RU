...
-- 
-- -- Restore quiz_results_summary dari backup
-- UPDATE quiz_results_summary qrs
-- SET 
--     total_questions = backup.total_questions,
--     correct_answers = backup.correct_answers,
--     score_percentage = backup.score_percentage,
